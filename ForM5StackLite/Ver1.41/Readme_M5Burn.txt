━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Wifi_Rig_CW for M5ATOM Lite  Ver1.41
...
2通りの使い方ができます。
  ...
  ② USB 中継モード（Android アプリ Wifi_RIG_CTRL v1.41 との組み合わせ）
     ...
     Ver1.41 より SYNC トンネル機能に対応し、VPN 越し運用時の
     CW タイミング精度が向上しました。


【ファームウェアの種類】
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  Clie_M5AtomLitev1.41.bin  クライアント用（電鍵を接続する側）
  Serv_M5AtomLitev1.41.bin  サーバー用（無線機のキー端子に接続する側）
...
【前提】
  Android スマートフォンに Wifi_RIG_CTRL for Android v1.41 をインストール済み
...
Wifi_Rig_CW is a CW keyer system using M5ATOM Lite that supports two operation modes:
  ...
  Mode 2: USB Relay (with Android app "Wifi_RIG_CTRL" v1.41)
    ...
    Ver1.41 adds SYNC tunnel support, improving CW timing accuracy over VPN.


Firmware Files
--------------
  Clie_M5AtomLitev1.41.bin   Client firmware (connect your key to this unit)
  Serv_M5AtomLitev1.41.bin   Server firmware (connect to radio key terminal via optocoupler)
...
-----------------------
Requirements:
  Android smartphone with Wifi_RIG_CTRL v1.41 installed
...
- Source code is available in the ソースコード/Ver1.41/ folder.
- WiFi profile templates are in ソースコード/Ver1.41/Wifiプロファイル/.
...
- Raspberry Pi setup scripts and the Android APK are available at:
  https://github.com/ji1ore/M5CoreHamCAT/tree/main/v1.41/
